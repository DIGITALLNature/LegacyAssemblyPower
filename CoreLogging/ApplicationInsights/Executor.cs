...
namespace D365.Extension.Core
{
    public abstract partial class Executor
    {
        ...
        //default keys
        public virtual string LoggingServiceInstrumentationKey { get; protected set; } = "LoggingService.InstrumentationKey";
        public virtual string LoggingServiceDebug { get; protected set; } = "LoggingService.Debug";
        public virtual string LoggingServiceLogLevel { get; protected set; } = "LoggingService.LogLevel";
    }
